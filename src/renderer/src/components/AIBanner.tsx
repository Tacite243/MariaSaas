...
export const AIBanner: React.FC = () => {
  return (
    <div className="bg-emerald-600 dark:bg-slate-900 p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] text-white relative overflow-hidden group shadow-2xl transition-colors">
       {/* Background Effects */}
       ...
       <div className="relative z-10">
          ...
          <div className="flex items-center gap-6">
             <div className="flex -space-x-3">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-emerald-700 dark:bg-slate-800 border-4 border-emerald-600 dark:border-slate-900 flex items-center justify-center font-black text-[10px]">IA</div>
             </div>
             <p className="text-[10px] font-black text-white dark:text-sky-400 uppercase tracking-widest bg-black/10 dark:bg-transparent px-3 py-1 rounded-full">Connecté</p>
          </div>
       </div>
    </div>
  );

...
import { addToCart, removeFromCart, updateQuantity, setPaymentMethod, processCheckout } from '@renderer/app/store/slice/salesSlice';
...
export const usePosLogic = () => {
    ...
    const actions = {
        setSearchTerm,
        addToCart: (product: any) => dispatch(addToCart({
        ...
        setPaymentMethod: (method: any) => dispatch(setPaymentMethod(method)),
